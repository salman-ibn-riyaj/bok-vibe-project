...
const ReadList = ({sortingType}) => {
  ...
  return (
    <>
      {filteredStoredBooks.length === 0 ? <div className="text-center p-5 bg-amber-100 rounded-2xl my-2 container mx-auto"><h2 className="font-bold">No Read list Data found!</h2> </div> :
